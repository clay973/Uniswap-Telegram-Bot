        ...
        for transactionhash in utb.transactionhashes:
            ...
            if ut.action == "Sold" or ut.action == "Bought":
                ...
                "link</a>"
                    ...
                    primarytokenamount = formatnumber(ut.primarytokenamount,4),
                    ...
                    pairtokeneurprice = formatnumber(ut.pairtoken.eurprice,4),
                    pairtokenusdprice = formatnumber(ut.pairtoken.usdprice,4),
                    eurpricetotal = formatnumber(ut.eurpricetotal),
                    usdpricetotal = formatnumber(ut.usdpricetotal),
                    txhash = ut.txhash,
                    blocknumber = ut.blocknumber,
                    eurpricepertoken= formatnumber(ut.eurpricepertoken,4),
                    usdpricepertoken= formatnumber(ut.usdpricepertoken,4),
